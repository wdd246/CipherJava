...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        */
        ...
        cipher.setAlpha(Alphabet.UpperCaseENG);
        
        Cipher cesar = new Cipher(new CesarCharProc(cipher.getAlpha(),1));//set alphabet & key
        System.out.println("cipher.encrypt by Cesar: "+cesar.encrypt(txt));
        
        Cipher subst = new Cipher(new SubstCharProc(cipher.getAlpha(),Alphabet.SubUpperCaseENG));//set alphabet & key
        System.out.println("cipher.encrypt by Subst: "+subst.encrypt(txt));
